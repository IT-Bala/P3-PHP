...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2016 at 11:54 AM
...
ALTER TABLE `tbl_users`
 ADD PRIMARY KEY (`user_id`), ADD KEY `first_name` (`first_name`), ADD KEY `last_name` (`last_name`), ADD KEY `username` (`username`), ADD KEY `phone` (`phone`), ADD KEY `email` (`email`), ADD KEY `address` (`address`);
